...
## Портфолио ML- и DL-проектов
 ...
 | Проект | Задачи проекта | Стек |
| :-----------| :----------- | :----------- |
| [Определение возраста по фото]([https://github.com/kharnakhoeva/portfolio/blob/main/p15_supermarket/image_recognition_project15_kharnakhoeva.ipynb](https://github.com/kharnakhoeva/portfolio/tree/main/p15_supermarket)) | Задача: построить модель, которая по фотографии человека могла бы предсказывать его возраст | Python, Keras |
